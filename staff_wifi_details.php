	...
	<table id="memListTable" class="table table-striped table-bordered" style="width:100%; font-size:13px;">
		<thead>
			<tr>
				...
				<th>Device</th>
				<th style="max-width: 150px;min-width: 150px;">MAC Adress</th>
				<th>Server</th>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body view-body">
					<p><span class="view_title">Name : </span> <label class="view_name ans"></label></p>
					<p><span class="view_title">Designation : </span> <label class="view_designation ans"></label></p>
					<p><span class="view_title">Department : </span> <label class="view_department ans"></label></p>
...
<script src="js/staff_wifi_details.js"></script>
<script>
	$('#top-title').text("Staff WI-FI Details");
</script>